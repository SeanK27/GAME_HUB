...
def displayprice():
    displayHubCoin("3.50", 135, 295, dgreen)
    displayHubCoin("5", 450, 295, dgreen)
    displayHubCoin("69", 770, 295, dgreen)
    displayHubCoin("100", 770, 475, dgreen)
    displayHubCoin("75", 450, 475, dgreen)
    displayHubCoin("50", 135, 475, dgreen)
...
def drawTitle():  # Title Screen
    screen.fill(black)
    pygame.draw.rect(screen, vars.color, (0, 0, 1000, 600), 2)
    ...
    if vars.user == "":
        ...
        show_text("Hi " + profanity.censor(vars.user) + "!", 3, 3, white)
...
def drawNFT():
    ...
    pygame.draw.rect(screen, red, (55, 200, 230, 130), 10)
    pygame.draw.rect(screen, blue, (370, 200, 230, 130), 10)
    pygame.draw.rect(screen, purple, (685, 200, 230, 130), 10)
    pygame.draw.rect(screen, orange, (55, 380, 230, 130), 10)
    pygame.draw.rect(screen, cyan, (370, 380, 230, 130), 10)
    pygame.draw.rect(screen, white, (685, 380, 230, 130), 10)
...
def drawNFT0():
    ...
    screen.blit(nfts, (345, 25))
    screen.blit(escButton, (20, 20))
    pygame.draw.rect(screen, red, (55, 200, 230, 130), 75)
    pygame.draw.rect(screen, blue, (370, 200, 230, 130), 10)
    pygame.draw.rect(screen, purple, (685, 200, 230, 130), 10)
    pygame.draw.rect(screen, orange, (55, 380, 230, 130), 10)
    pygame.draw.rect(screen, cyan, (370, 380, 230, 130), 10)
...
def drawNFT1():
    ...
    screen.blit(escButton, (20, 20))
    pygame.draw.rect(screen, red, (55, 200, 230, 130), 10)
    pygame.draw.rect(screen, blue, (370, 200, 230, 130), 75)
    pygame.draw.rect(screen, purple, (685, 200, 230, 130), 10)
    pygame.draw.rect(screen, orange, (55, 380, 230, 130), 10)
    pygame.draw.rect(screen, cyan, (370, 380, 230, 130), 10)
    pygame.draw.rect(screen, white, (685, 380, 230, 130), 10)
...
def drawNFT2():
    ...
    pygame.draw.rect(screen, red, (55, 200, 230, 130), 10)
    pygame.draw.rect(screen, blue, (370, 200, 230, 130), 10)
    pygame.draw.rect(screen, purple, (685, 200, 230, 130), 75)
    pygame.draw.rect(screen, orange, (55, 380, 230, 130), 10)
    pygame.draw.rect(screen, cyan, (370, 380, 230, 130), 10)
    pygame.draw.rect(screen, white, (685, 380, 230, 130), 10)
    screen.blit(purchase, (450, 530))
...
def drawNFT3():
    ...
    pygame.draw.rect(screen, blue, (370, 200, 230, 130), 10)
    pygame.draw.rect(screen, purple, (685, 200, 230, 130), 10)
    pygame.draw.rect(screen, orange, (55, 380, 230, 130), 75)
    pygame.draw.rect(screen, cyan, (370, 380, 230, 130), 10)
    pygame.draw.rect(screen, white, (685, 380, 230, 130), 10)
    screen.blit(purchase, (450, 530))
    # screen.blit(moonBig, (155, 420))
...
def drawNFT4():
    ...
    pygame.draw.rect(screen, purple, (685, 200, 230, 130), 10)
    pygame.draw.rect(screen, orange, (55, 380, 230, 130), 10)
    pygame.draw.rect(screen, cyan, (370, 380, 230, 130), 75)
    pygame.draw.rect(screen, white, (685, 380, 230, 130), 10)
    screen.blit(purchase, (450, 530))
    # screen.blit(moonBig, (155, 420))
    # screen.blit(boltBig, (470, 420))
...
def drawNFT5():
    ...
    pygame.draw.rect(screen, orange, (55, 380, 230, 130), 10)
    pygame.draw.rect(screen, cyan, (370, 380, 230, 130), 10)
    pygame.draw.rect(screen, white, (685, 380, 230, 130), 75)
    screen.blit(purchase, (450, 530))
    # screen.blit(moonBig, (155, 420))
    # screen.blit(boltBig, (470, 420))
    screen.blit(starBig, (785, 420))
...
def drawNFT5esc():
    ...
    screen.blit(nfts, (345, 25))
    screen.blit(sescButton, (20, 20))
    pygame.draw.rect(screen, white, (55, 200, 230, 130), 10)
    pygame.draw.rect(screen, yellow, (370, 200, 230, 130), 10)
    pygame.draw.rect(screen, cyan, (685, 200, 230, 130), 10)
...
def leaderboard():
    ...
    show_text_size("2. " + str(profanity.censor(vars.sorted[1][0])) + " - " + str(vars.sorted[1][2]) + " Hub Coin", 350,
                   150, white, 30)
    show_text_size("3. " + str(profanity.censor(vars.sorted[2][0])) + " - " + str(vars.sorted[2][2]) + " Hub Coin", 350,
                   175, white, 30)
    show_text_size("4. " + str(profanity.censor(vars.sorted[3][0])) + " - " + str(vars.sorted[3][2]) + " Hub Coin", 350,
                   200, white, 30)
    show_text_size("5. " + str(profanity.censor(vars.sorted[4][0])) + " - " + str(vars.sorted[4][2]) + " Hub Coin", 350,
                   225, white, 30)
    show_text_size("6. " + str(profanity.censor(vars.sorted[5][0])) + " - " + str(vars.sorted[5][2]) + " Hub Coin", 350,
                   250, white, 30)
    show_text_size("7. " + str(profanity.censor(vars.sorted[6][0])) + " - " + str(vars.sorted[6][2]) + " Hub Coin", 350,
                   275, white, 30)
    show_text_size("8. " + str(profanity.censor(vars.sorted[7][0])) + " - " + str(vars.sorted[7][2]) + " Hub Coin", 350,
                   300, white, 30)
    show_text_size("9. " + str(profanity.censor(vars.sorted[8][0])) + " - " + str(vars.sorted[8][2]) + " Hub Coin", 350,
                   325, white, 30)
    show_text_size("10. " + str(profanity.censor(vars.sorted[9][0])) + " - " + str(vars.sorted[9][2]) + " Hub Coin",
                   350, 350, white, 30)
    moneys = 0.0
    for user in vars.users:
        if user[0] == vars.user:
            moneys = user[2]
    if vars.user != '':
        show_text_size(str(profanity.censor(vars.user)) + ": " + str(moneys), 450, 425, white,
                       30)  # This one shows your net worth and ranking if you're not top 10
    pygame.display.update()
...
def drawHelp():
    ...
    show_text("This is a single player game where you click on the cupcake to gain clicks. Each 500 clicks ", 24, 210,
              white)
    show_text("is worth 1 HubCoin. ", 24, 235, white)

    show_text_size("S'kaavok", 24, 285, white, 45)
    show_text("This is a single player game where the goal is to click the targets as fast as you can before ", 24, 310,
              white)
    ...
    show_text("This game is based on the popular game called Snake. You control a worm like object and ", 24, 410,
              white)
    show_text("eat as many apples as you can. Each time you eat an apple, the worm grows in length. Use the ", 24, 435,
              white)
